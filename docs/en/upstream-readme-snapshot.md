...
| `claude/<model>`      | `claude`     | Claude Code pinned to a specific model  |
...
| `Missing required command: claude` (or `codex` / `opencode` / `agy` for `--agent antigravity`)                                       | Agent CLI not installed                                                                                      | See [Supported Agent CLIs](#supported-agent-clis) for install + auth                                                                                                                |
...
| `Invalid agent: …`                                                                                                                   | Typo in `--agent` value                                                                                      | Must be one of `claude`, `codex`, `spark`, `sparc`, `opencode`, `antigravity`, optionally with a `/<model>` suffix on `claude`, `codex`, `opencode`, or `antigravity` (`spark`/`sparc` take no suffix — use `codex/<model>`) |
